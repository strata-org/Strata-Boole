...
-- The candidate validator accepts cvc5's primary candidate (e.g. a = 2)
-- because nat_toInt(2) ≥ 2 satisfies the requires.
...
Obligation: assert_2_1076
Property: assert
Result: ❌ fail

Obligation: test_nat_range_ensures_1_1045
Property: assert
Result: ❌ fail
-/
#guard_msgs in
...
/-- info:
Obligation: test_intlist_head_pre_test_intlist_head_requires_1_2704_calls_IntList..head_0
Property: assert
Result: ✅ pass

Obligation: test_intlist_head_post_test_intlist_head_ensures_2_2737_calls_IntList..head_0
Property: assert
Result: ✅ pass

Obligation: assert_assert_3_2772_calls_IntList..head_0
Property: assert
Result: ✅ pass

Obligation: assert_3_2772
Property: assert
Result: ❌ fail

Obligation: test_intlist_head_ensures_2_2737
Property: assert
Result: ❌ fail
-/
#guard_msgs in
...
-- Uses the `nat_mul` operation; cvc5 finds a counterexample at any a.
...
Obligation: assert_1_3838
Property: assert
Result: ❌ fail

Obligation: test_nat_square_ensures_0_3796
Property: assert
Result: ❌ fail
-/
#guard_msgs in
...
Obligation: test_natlist_nonneg_post_test_natlist_nonneg_ensures_1_5548_calls_NatList..head_0
Property: assert
Result: ✅ pass

Obligation: assert_assert_2_5594_calls_NatList..head_0
Property: assert
Result: ✅ pass

Obligation: assert_2_5594
Property: assert
Result: ✅ pass

Obligation: test_natlist_nonneg_ensures_1_5548
Property: assert
Result: ✅ pass
-/
#guard_msgs in
