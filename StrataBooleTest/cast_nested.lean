...
procedure cast_in_forall(s: Sequence (bv W8), n: int) returns ()
spec {
...
procedure cast_compound_bv(a: bv W8, b: bv W8) returns ()
spec {
...
procedure cast_sum_bound(a: bv W8, b: bv W8) returns ()
spec {
...
procedure cast_in_let(x: bv W8) returns ()
spec {
...
procedure cast_in_exists(x: bv W64) returns ()
spec {
...
rec function bytes_to_nat(s: Sequence (bv W8)) : int
...
axiom (∀ h: bv W8 . ∀ t: Sequence (bv W8) .
...
procedure test_rec_single_byte(x: bv W8) returns ()
spec {
...
rec function countdown_bv(n: bv W8) : int
  decreases as_uint(n)
{
  if n == bv{8}(0) then 0
...
function decode_low_byte(b: bv W8) : int
  requires as_uint(b) < 128;
{
  as_uint(b)
}

procedure call_decode_byte(x: bv W8) returns (r: int)
spec {
...
/-- info:
Obligation: cast_in_forall_post_cast_in_forall_ensures_1_845_calls_Sequence.select_0
Property: out-of-bounds access check
Result: ✅ pass

Obligation: assert_assert_2_931_calls_Sequence.select_0
Property: out-of-bounds access check
Result: ✅ pass

Obligation: assert_2_931
Property: assert
Result: ✅ pass

Obligation: cast_in_forall_ensures_1_845
Property: assert
Result: ✅ pass

Obligation: assert_5_1148
Property: assert
Result: ✅ pass

Obligation: assert_6_1178
Property: assert
Result: ✅ pass

Obligation: cast_compound_bv_ensures_3_1081
Property: assert
Result: ✅ pass

Obligation: cast_compound_bv_ensures_4_1112
Property: assert
Result: ✅ pass

Obligation: assert_8_1321
Property: assert
Result: ✅ pass

Obligation: cast_sum_bound_ensures_7_1276
Property: assert
Result: ✅ pass

Obligation: assert_10_1477
Property: assert
Result: ✅ pass

Obligation: cast_in_let_ensures_9_1415
Property: assert
Result: ✅ pass

Obligation: assert_12_1647
Property: assert
Result: ✅ pass

Obligation: cast_in_exists_ensures_11_1592
Property: assert
Result: ✅ pass
...
Obligation: test_rec_empty_ensures_15_2126
Property: assert
Result: ✅ pass

Obligation: test_rec_single_byte_ensures_16_2263
Property: assert
Result: ✅ pass
...
Obligation: call_decode_byte_ensures_19_2839
Property: assert
Result: ✅ pass-/
#guard_msgs in
