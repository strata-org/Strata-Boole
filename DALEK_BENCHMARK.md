...
Run it once end to end to check the setup. That first run is much slower than the ones
after it; once the caches exist, a run is a few minutes, mostly Verus verification.
